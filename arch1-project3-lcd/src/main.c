...
volatile uint8_t collision = 0; // Collision state

// Assembly function for custom logic
...
void play_hyrule_theme() {
  // Simulate an 8-bit Hyrule Field Theme using the buzzer
...
void display_start_screen() {
  ...
  drawString5x7(20, 100, "Press BTN1 to Play", COLOR_WHITE, COLOR_BLACK);
}
...
void display_game_over() {
  ...
  drawString5x7(20, 100, "Press BTN1 to Restart", COLOR_WHITE, COLOR_BLACK);
}
