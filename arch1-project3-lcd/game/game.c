...
int player_position = 1; // Player's position (0: left, 1: center, 2: right)
int object_position = 1; // Falling object's horizontal position
int object_y = 20;       // Falling object's vertical position
